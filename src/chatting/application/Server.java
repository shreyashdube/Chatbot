...
import java.net.*; // used for server socket.
import java.io.*; // datainput stream isle andr ataa hai input lene ke liye.
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String[] args){
        ...
        // Making server to connect.
        try{
            ServerSocket skt = new ServerSocket(6001);
            while(true) {
                Socket s = skt.accept();// infinite msg ko accept krne ke liye infinite loop.
